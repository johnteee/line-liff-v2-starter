...
function displayLiffData() {
    window.liffInfo = window.liffInfo ? window.liffInfo : {}

    window.liffInfo['browserLanguage'] = liff.getLanguage();
    window.liffInfo['sdkVersion'] = liff.getVersion();
    window.liffInfo['lineVersion'] = liff.getLineVersion();
    window.liffInfo['isInClient'] = liff.isInClient();
